		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 - Claude App",
									"targetURL": "#ui5claudeui5claude-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5claudeui5claude-display": {
								"semanticObject": "ui5claudeui5claude",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5.claude",
									"url": sap.ui.require.toUrl("ui5/claude")
								}
							}
						}
					}
